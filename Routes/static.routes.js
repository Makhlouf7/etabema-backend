...
import { createStatic, getAllStatic, getElementById, updateElement } from "../Controllers/static.controller.js";
import {
    authencatication,
    restrictTo,
...
staticRouter.route("/create-static").post(restrictTo("admin"),upload.fields([
...
staticRouter.route('/:id').patch(restrictTo('admin') ,upload.fields([
    { name: "logoURL", maxCount: 1 },
    { name: "homeHeroURL", maxCount: 1 },
    { name: "servicesHeroURL", maxCount:1 },
    { name: "categoriesHeroURL", maxCount: 1 },
